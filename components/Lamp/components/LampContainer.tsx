...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-150 w-200 flex-col items-center justify-center overflow-hidden bg-slate-950 rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          ...
          <div className="absolute w-40 h-full left-0 bg-slate-950  bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        >
          ...
          <div className="absolute  w-full right-0 bg-slate-950 h-40 bottom-0 z-20 mask-[linear-gradient(to_left,white,transparent)]" />
        </motion.div>
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-50 bg-slate-950 " />
      </div>
